	...
	$(document).ready(function() {
		oTable = $('#otable').DataTable(
			...
			"ajax" : function(data, callback, settings) {
				//封装请求参数
				var param = physicalManage.getQueryCondition(data);
				$.ajax({
					type : "GET",
					url : "/physical/page",//TODO
					cache : false, //禁用缓存
					data : param, //传入已封装的参数
					dataType : "json",
			...
			"columns" : [
				...
				CONSTANT.DATA_TABLES.COLUMN.OPERATION_DETAIL
				],
			"columnDefs" : [ {
					"searchable" : false,
					"orderable" : false,
	...
	var physicalManage = {
		...
		getQueryCondition : function(data) {
			...
			//组装查询参数
			param.fuzzySearch = physicalManage.fuzzySearch;
			if (physicalManage.fuzzySearch) {//模糊查询
